...
void Hardware_Information() {
    ...
    while (1) {
        ...
        if (strcmp(input, "1") == 0) {
            clearScreen();
            printf(":\\Hardware Information\\View processor info\n");
            printf("-------------------------------------------------------------------------------------------- \n");
            ...
            clearScreen();
            printf(":\\Hardware Information\\Display motherboard details\n");
            printf("-------------------------------------------------------------------------------------------- \n");
            ...
            clearScreen();
            printf(":\\Hardware Information\\Check RAM info\n");
            printf("-------------------------------------------------------------------------------------------- \n");
            ...
            clearScreen();
            printf(":\\Hardware Information\\View graphics card details\n");
            printf("-------------------------------------------------------------------------------------------- \n");
            ...
            clearScreen();
            printf(":\\Hardware Information\\Check disk details\n");
           printf("-------------------------------------------------------------------------------------------- \n");
            ...
            clearScreen();
            printf(":\\Hardware Information\\List logical drives\n");
            printf("-------------------------------------------------------------------------------------------- \n");
